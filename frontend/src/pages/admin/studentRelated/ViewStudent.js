...
const ViewStudent = () => {
    ...
    const subjectData = Object.entries(groupAttendanceBySubject(subjectAttendance)).map(([subName, {
        subCode,
        present,
        sessions
    }]) => {
            ...
            return (
                <>
                    ...
                    <Table>
                        ...
                        {Object.entries(groupAttendanceBySubject(subjectAttendance)).map(([subName, {
                                present,
                                allData,
                                subId,
                                sessions
                                        ...
                                        <StyledTableRow>
                                            ...
                                            <StyledTableCell align="center">
                                                <Button variant="contained"
                                                    ...
                                                    {openStates[subId] ? <KeyboardArrowUp/> : <KeyboardArrowDown/>}Подробности
                                                </Button>
                                                                ...
                                                                {allData.map((data, index) => {
                                                                    ...
                                                                    return (
                                                                        <StyledTableRow key={index}>
                                                                            ...
                                                                            <StyledTableCell
                                                                                align="right">{data.status}</StyledTableCell>
                                                                        </StyledTableRow>
                                                                    )
                                                                })}
                                                            </TableBody>
                    ...
                    <Button variant="contained" sx={styles.styledButton}
